package com.java.core.algorithm;

import java.util.concurrent.CountDownLatch;

/**
 * merge CountDownLatch sort
 * @author Tim
 *
 */
public abstract class MergeParallelSort {
	...
	public static void sortParallel(final int[] numbers, final int pos, final int end, final int asynDepth,
			final int depth) {
		if ((end - pos) > 1) {
