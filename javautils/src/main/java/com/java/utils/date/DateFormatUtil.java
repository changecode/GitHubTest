...
import com.java.utils.common.CommonUtils;
...
public class DateFormatUtil {
	...
	/**
	 * @Title: dateToString @Description: TODO(这里用一句话描述这个方法的作用) @param @param
	 * date @param @param formate @param @return 设定文件 @return String
	 * 返回类型 @throws
	 */
